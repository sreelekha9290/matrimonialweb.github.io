...
public class Users {
	...
	public Users(int id, String profile, String name, String gender, int age,
			String religion, String language, String country, String email,
			String mobile, String password, String question, String answer,
			String sign) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Users [id=" + id + ", profile=" + profile + ", name=" + name
